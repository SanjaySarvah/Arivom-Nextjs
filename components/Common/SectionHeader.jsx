  ...
  return (
    <div className="mb-8 text-left">
      <div className="flex items-center gap-4">
        ...
        {/* Optional Button (uses Next.js Link) */}
        {showButton && (
          <Link
            href={buttonUrl}
            className="relative px-6 py-2 font-semibold rounded-lg border-2 border-green-500 text-green-600 overflow-hidden transition-all duration-300 group flex items-center gap-2"
